...
const MESSAGES = {
  "pt-BR": {
    ...
    ariaProjectScrollHint: "Rolar o texto do projeto",
    ...
    cameraNavTitle: "Camera Navigation",
    cameraNavSummary: "Controle o cursor do desktop com hand tracking.",
    cameraNavStart: "Ativar",
    cameraNavStop: "Parar",
    cameraNavLoading: "Iniciando câmera e modelos de tracking...",
    cameraNavReady: "Tracking ativo. Mantenha sua mão visível para mover o cursor.",
    cameraNavUnsupported: "Este navegador não oferece suporte à câmera necessária.",
    cameraNavDesktopOnly: "Este controle foi habilitado apenas para desktop.",
    cameraNavPermissionDenied: "Não foi possível acessar a câmera.",
    cameraNavLauncher: "Abrir controles da camera",
    cameraNavOn: "Camera ativa",
    cameraNavClose: "Fechar",
    cameraNavHint: "Abra para ver os gestos e ativar a camera.",
    cameraNavHandHelp: "Mova o cursor com a ponta do indicador. Feche a mao para segurar e arrastar o scroll.",
    cameraNavClickHelp: "Abra a mao para soltar. Faca uma pinca com polegar + indicador para clicar.",
    cameraNavGrabStart: "Mao fechada: segurando e pronta para arrastar.",
    cameraNavRelease: "Mao aberta: soltando.",
    cameraNavClick: "Pinca detectada: clique enviado.",
  },
  en: {
    navHome: "Home",
    ...
    ariaProjectScrollHint: "Scroll project details",
    ...
    cameraNavTitle: "Camera Navigation",
    cameraNavSummary: "Control the desktop cursor with hand tracking.",
    cameraNavStart: "Start",
    cameraNavStop: "Stop",
    cameraNavLoading: "Starting camera and tracking models...",
    cameraNavReady: "Tracking is active. Keep your hand visible to move the cursor.",
    cameraNavUnsupported: "This browser does not support the required camera APIs.",
    cameraNavDesktopOnly: "This control is only enabled on desktop.",
    cameraNavPermissionDenied: "Camera access was not granted.",
    cameraNavLauncher: "Open camera controls",
    cameraNavOn: "Camera on",
    cameraNavClose: "Close",
    cameraNavHint: "Open to see the gestures and start the camera.",
    cameraNavHandHelp: "Move the cursor with your index fingertip. Close your hand to hold and drag-scroll.",
    cameraNavClickHelp: "Open your hand to release. Pinch thumb + index finger to click.",
    cameraNavGrabStart: "Closed hand: holding and ready to drag.",
    cameraNavRelease: "Open hand: releasing.",
    cameraNavClick: "Pinch detected: click sent.",
  },
  es: {
    navHome: "Inicio",
    ...
    ariaProjectScrollHint: "Desplazar el texto del proyecto",
    ...
    cameraNavTitle: "Camera Navigation",
    cameraNavSummary: "Controla el cursor del escritorio con hand tracking.",
    cameraNavStart: "Activar",
    cameraNavStop: "Detener",
    cameraNavLoading: "Iniciando cámara y modelos de tracking...",
    cameraNavReady: "El tracking está activo. Mantén la mano visible para mover el cursor.",
    cameraNavUnsupported: "Este navegador no ofrece compatibilidad con la cámara necesaria.",
    cameraNavDesktopOnly: "Este control solo está habilitado en escritorio.",
    cameraNavPermissionDenied: "No se pudo acceder a la cámara.",
    cameraNavLauncher: "Abrir controles de camara",
    cameraNavOn: "Camara activa",
    cameraNavClose: "Cerrar",
    cameraNavHint: "Abre para ver los gestos y activar la camara.",
    cameraNavHandHelp: "Mueve el cursor con la punta del indice. Cierra la mano para sujetar y arrastrar el scroll.",
    cameraNavClickHelp: "Abre la mano para soltar. Haz pinza con pulgar + indice para hacer clic.",
    cameraNavGrabStart: "Mano cerrada: sujetando y lista para arrastrar.",
    cameraNavRelease: "Mano abierta: soltando.",
    cameraNavClick: "Pinza detectada: clic enviado.",
  },
} as const;
