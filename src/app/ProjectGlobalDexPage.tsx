          ...
          >
            ...
            >
              ...
              <div className="flex w-full flex-1 items-center justify-center">
                <div
                  className="relative w-[min(100%,778px)] aspect-[778/539] overflow-hidden rounded-[40px] sm:w-[clamp(700px,62vw,860px)]"
                  data-node-id="30:86"
                >
            ...
            >
              ...
              <p className="w-full font-bold" data-node-id="30:98">
                {"PROXIMO PROJETO>"}
              </p>
            </div>
          </div>
